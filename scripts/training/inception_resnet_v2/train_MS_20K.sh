...
export TRAIN_DIR=$TFFACE_ROOT_DIR/tensorflow/models/inception_resnet_v2/MS_20K
...
export CHECKPOINT_PATH=$TFFACE_ROOT_DIR/tensorflow/models/tensorflow-slim/inception_resnet_v2/inception_resnet_v2.ckpt
...
#export LD_LIBRARY_PATH=/usr/local/cuda-8.0/lib64:$LD_LIBRARY_PATH
#tensorboard --logdir=$TFFACE_ROOT_DIR/tensorflow/models/inception_resnet_v2/MS_20K --port 6007 &
